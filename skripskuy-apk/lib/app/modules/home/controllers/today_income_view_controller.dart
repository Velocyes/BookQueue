...
class TodayIncomeViewController extends GetxController
  ...
  TodayIncomeViewController(this.homeControllerIndicator);
  ...
  Future<void> initTodayIncome() async {
    try {
      ...
      serviceProvider
        ...
        orderProvider
            .getTodayIncomeJson(serviceId: this.serviceObj?.value?.id ?? 0)
            .then((todayIncomeJson) {
          if (todayIncomeJson != null) {
            change(todayIncomeJson, status: RxStatus.success());
          } else {
